...
export default function OrderDetailPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 space-y-6">
      ...
      {order.is_quote && (
        <div className="flex items-center gap-3 px-4 py-3 rounded-xl border border-cyan-200 dark:border-cyan-500/30
                        bg-cyan-50 dark:bg-cyan-500/10 text-cyan-800 dark:text-cyan-300 text-sm">
          <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
              d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          <span>
            Esta es una <strong>solicitud de cotización</strong>: el total mostrado es estimado y todavía no se ha
            cobrado. Nuestro equipo te va a contactar para confirmar precio final y disponibilidad.
          </span>
        </div>
      )}
